	...
	sop = (function() {
		...
		var exportLm = function () {
			...
			$.getJSON( trackingUrl, function( data ) { // trigger trackingdata
				...
				// var o_data={
					// "cmi":[["4","cmi.core.lesson_status","passed"]],
					// "saved_global_status":1,//iv.status.saved_global_status,aus init_data
					// "now_global_status":1,
					// "percentageCompleted":50,
					// // "lp_mode":6,
					// "hash":"",
					// "p":6,
					// "totalTimeCentisec":60
				// };
				// if (setData("scormPlayerUnload",[sopGlobals.ilClient,sopGlobals.lmId,4])=="ok")

						// getData("lmGetAllByClientAndObjIdAtInitOfPlayer",[sopGlobals.ilClient,sopGlobals.lmId]);
