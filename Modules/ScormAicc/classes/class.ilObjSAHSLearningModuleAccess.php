    ...
    function _getCommands($a_obj_id)
    {
		...
		if (ilObjSAHSLearningModuleAccess::_lookupOfflineModeAvailable($a_obj_id)) {
			...
			if ($offlineMode == false) {
				...
				$commands[]=array("permission" => "read", "cmd" => "offlineMode2Start", "lang_var" => "offline_mode2");
			}
			else {
				...
				$commands[]=array("permission" => "read", "cmd" => "offlineMode2Stop", "lang_var" => "offline_mode2");
				$commands[]=array("permission" => "read", "cmd" => "offlineMode2View", "lang_var" => "show2","default" => true);
			}
		}
